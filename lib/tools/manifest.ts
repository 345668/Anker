...
export const NATIVE_TOOLS: NativeTool[] = [
  ...
  // ─── Planned (clearly marked, no fake links) ─────────────────────────
  {
    ...
    description: "New-customer acquisition, repeat-order cohorts, AOV & COGS drift, shipping economics, contribution margin. Live calculator + xlsx export.",
    audience: "founder",
    category: "Ecommerce",
  ...
  },
  {
    ...
    description: "Sales-led pipeline → bookings → billings → recognized revenue with deferred-revenue roll-forward (ASC 606). CAC payback + magic number.",
    audience: "founder",
    category: "SaaS",
  ...
  },
  {
    slug: "fund-of-funds",
    title: "Fund of Funds",
    description: "Multi-sub-fund allocator — exit-mix-driven sub-fund multiples, J-curve aggregation, double fee layer, portfolio TVPI / DPI / net IRR.",
    audience: "vc",
    category: "VC Fund Modeling",
  ...
  },
  {
    ...
    description: "0/20/20 venture-studio fund — NewCo launches, studio common ownership, fund + studio twin entities, LP waterfall. Live calculator + xlsx export.",
    audience: "vc",
    category: "VC Fund Modeling",
