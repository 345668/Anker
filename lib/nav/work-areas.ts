...
export const WORK_AREAS: Record<Persona, [string, string[]][]> = {
  ...
  vc: [
    ["Deals", ["/dashboard/portfolio/fund/deals", "/dashboard/calls"]],
    ...
    ["Fund operations", ["/dashboard/portfolio/fund", "/dashboard/kyc-aml", "/dashboard/fund-tax", "/dashboard/spvs", "/dashboard/loan-operations", "/dashboard/contracts"]],
