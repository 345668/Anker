...
export type SendSnapshot = { title: string; body: string; asks: string; startedAt: string; senderUserId?: string; recipients: { crmEntryId?: string; email: string; name?: string; trackingId: string }[] }
