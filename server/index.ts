...
// SECURITY: Reduced body size limits to prevent resource exhaustion attacks
// Use 5mb for general requests; file uploads should use streaming and separate endpoints
app.use(
  express.json({
    limit: '5mb',
    verify: (req, _res, buf) => {
