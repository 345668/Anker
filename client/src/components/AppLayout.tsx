...
const founderNavItems: NavItem[] = [
  ...
  { label: "Firms", href: "/app/firms", icon: Building2, description: "Browse all investment firms" },
  { label: "Investors", href: "/app/investors", icon: Users, description: "Browse all individual investors" },
