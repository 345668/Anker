...
// /:https://framerusercontent.com/modules/uqhXLkfnhgObU49vQfNx/1rJWKt7bM98ePcDQ12dm/nZeRYAqG_.js
...
var serializationHash = "framer-D6BC8";
var variantClassNames = {
	uBrfa6H2H: "framer-v-snfegd",
};
...
var Component = /* @__PURE__ */ React.forwardRef(function (props, ref) {
	...
	const isDisplayed = () => {
		if (gestureVariant === "uBrfa6H2H-hover") return false;
		return true;
	};
	const isDisplayed1 = () => {
		if (gestureVariant === "uBrfa6H2H-hover") return true;
		return false;
	};
	return (
				...
				<Transition value={transition1}>
					...
					>
						<motion.a
							{...restProps}
							{...gestureHandlers}
							className={`${cx(scopingClassNames, "framer-snfegd", className, classNames)} framer-zr1u1g`}
...
var css = [
	...
	".framer-D6BC8.framer-zr1u1g, .framer-D6BC8 .framer-zr1u1g { display: block; }",
	".framer-D6BC8.framer-snfegd { align-content: center; align-items: center; cursor: pointer; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 36px; justify-content: center; overflow: visible; padding: 0px; position: relative; text-decoration: none; width: 142px; }",
	".framer-D6BC8 .framer-1o3w7v5 { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 36px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 142px; }",
	".framer-D6BC8 .framer-1hgmymv { aspect-ratio: 5.4 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 15px); position: relative; width: 81px; }",
	".framer-D6BC8 .framer-1sj8m7h { aspect-ratio: 6.230769230769231 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 13px); position: relative; width: 81px; }",
];
var FramernZeRYAqG_ = withCSS(Component, css, "framer-D6BC8");
var stdin_default = FramernZeRYAqG_;
FramernZeRYAqG_.displayName = "Buy Template Button";
FramernZeRYAqG_.defaultProps = {
	height: 36,
	width: 142,
};
addPropertyControls(FramernZeRYAqG_, {
	ENbTeSegz: {
		title: "Link",
