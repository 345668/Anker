...
// /:https://framerusercontent.com/modules/uCICu2tMRvl1qx5s8P8s/KaGWVMDcquHbU8K4gnPP/upkXSuqX2.js
...
var serializationHash = "framer-4TPZO";
var variantClassNames = {
	xy_JtOX64: "framer-v-1u5nd6f",
};
var transition1 = {
	bounce: 0.2,
	delay: 0,
...
var getProps2 = ({ file, height, id, width, ...props }) => {
	return {
		...
		nYU0e6QoZ:
			file ??
			props.nYU0e6QoZ ??
			"https://framerusercontent.com/assets/vbOBoy0MLbMZbX0cLl9GPpNhA.mp4",
	};
};
...
var Component = /* @__PURE__ */ React3.forwardRef(function (props, ref) {
	...
	const { style, className, layoutId, variant, nYU0e6QoZ, ...restProps } =
		getProps2(props);
	const {
		baseVariant,
		classNames,
			...
			<Variants animate={variants} initial={false}>
				<Transition value={transition1}>
					...
					>
						<ComponentViewportProvider>
							<SmartComponentScopedContainer
								className={"framer-nhdofa-container"}
								isAuthoredByUser={true}
								isModuleExternal={true}
								layoutDependency={layoutDependency}
								layoutId={"ZvqUH5b18-container"}
								nodeId={"ZvqUH5b18"}
						...
						<MotionDivWithFX
							...
							__targetOpacity={1}
							className={"framer-11ipx59"}
							data-framer-name={"Overlay"}
							layoutDependency={layoutDependency}
							layoutId={"V8sk7rKUb"}
							style={{
								backgroundColor:
									"var(--token-cca5a9cb-374a-4528-8b21-e3181cfcaf4e, rgb(0, 0, 0))",
							}}
						/>
					</motion.div>
				</Transition>
...
var css = [
	...
	".framer-4TPZO.framer-1pqwnhv, .framer-4TPZO .framer-1pqwnhv { display: block; }",
	".framer-4TPZO.framer-1u5nd6f { height: 648px; overflow: hidden; position: relative; width: 1152px; }",
	".framer-4TPZO .framer-nhdofa-container { aspect-ratio: 1.7777777777777777 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 648px); left: 0px; position: absolute; right: 0px; top: 0px; }",
	".framer-4TPZO .framer-11ipx59 { bottom: -650px; flex: none; height: 650px; left: 0px; overflow: hidden; position: absolute; right: 0px; z-index: 2; }",
];
var FramerupkXSuqX2 = withCSS(Component, css, "framer-4TPZO");
var stdin_default = FramerupkXSuqX2;
FramerupkXSuqX2.displayName = "Video";
FramerupkXSuqX2.defaultProps = {
	height: 648,
	width: 1152,
};
addPropertyControls2(FramerupkXSuqX2, {
	nYU0e6QoZ: VideoControls?.["srcFile"] && {
		...VideoControls["srcFile"],
		__defaultAssetReference:
			"data:framer/asset-reference,vbOBoy0MLbMZbX0cLl9GPpNhA.mp4?originalFilename=17268806-Uhd+3840+2160+30Fps.mp4",
		description: void 0,
		hidden: void 0,
		title: "File",
	},
