  ...
  const downloadConsultingReport = async () => {
    ...
    try {
      const reportData = {
        ...
        strengths: analysis.enhanced?.strengths || analysis.enhanced?.deckQuality?.strengths || [],
        weaknesses: analysis.enhanced?.concerns || analysis.enhanced?.deckQuality?.weaknesses || [],
        ...
        recommendation: analysis.enhanced?.recommendation,
        recommendationRationale: analysis.enhanced?.recommendationRationale,
        criticalAssessment: analysis.enhanced?.criticalAssessment,
        redFlags: analysis.enhanced?.redFlags,
        nextSteps: analysis.enhanced?.nextSteps,
        extractedInfo: {
          companyName: analysis.extractedInfo.companyName,
          tagline: analysis.extractedInfo.tagline,
          description: analysis.extractedInfo.description,
          problem: analysis.extractedInfo.problem,
          solution: analysis.extractedInfo.solution,
          targetMarket: analysis.extractedInfo.targetMarket,
          businessModel: analysis.extractedInfo.businessModel,
          traction: analysis.extractedInfo.traction,
          team: analysis.extractedInfo.team,
          askAmount: analysis.extractedInfo.askAmount,
          useOfFunds: analysis.extractedInfo.useOfFunds,
          industries: analysis.extractedInfo.industries,
          stage: analysis.extractedInfo.stage,
        },
        marketOpportunity: analysis.enhanced?.marketOpportunity ? {
          tamClaimed: analysis.enhanced.marketOpportunity.tamClaimed,
          tamRealistic: analysis.enhanced.marketOpportunity.tamRealistic,
          samEstimate: analysis.enhanced.marketOpportunity.samEstimate,
          marketGrowth: analysis.enhanced.marketOpportunity.marketGrowth,
          assessment: analysis.enhanced.marketOpportunity.assessment,
          redFlags: analysis.enhanced.marketOpportunity.redFlags,
          score: analysis.enhanced.marketOpportunity.score,
        } : undefined,
        businessModel: analysis.enhanced?.businessModel ? {
          model: analysis.enhanced.businessModel.revenueStreams?.join(', '),
          pricing: analysis.enhanced.businessModel.unitEconomics ? 
            `CAC: ${analysis.enhanced.businessModel.unitEconomics.cac}, LTV: ${analysis.enhanced.businessModel.unitEconomics.ltv}` : undefined,
          margins: analysis.enhanced.businessModel.scalability,
          assessment: (analysis.enhanced.businessModel.concerns && analysis.enhanced.businessModel.concerns.length > 0) 
            ? `Concerns: ${analysis.enhanced.businessModel.concerns.join('; ')}` 
            : 'No significant concerns identified',
          score: analysis.enhanced.businessModel.score,
        } : undefined,
        team: analysis.enhanced?.team ? {
          founders: analysis.enhanced.team.founders?.map(f => ({
            name: f.name,
            role: f.role,
            background: f.background,
          })),
          gaps: analysis.enhanced.team.gaps,
          assessment: (analysis.enhanced.team.strengths && analysis.enhanced.team.strengths.length > 0)
            ? `Strengths: ${analysis.enhanced.team.strengths.join('; ')}`
            : 'Team strengths not assessed',
          score: analysis.enhanced.team.score,
        } : undefined,
        competitive: analysis.enhanced?.competitive ? {
          differentiation: analysis.enhanced.competitive.differentiation,
          moat: analysis.enhanced.competitive.moat,
          competitors: analysis.enhanced.competitive.competitors,
          score: analysis.enhanced.competitive.score,
        } : undefined,
        financials: analysis.enhanced?.financials ? {
          currentRevenue: analysis.enhanced.financials.currentRevenue,
          burnRate: analysis.enhanced.financials.burnRate,
          runway: analysis.enhanced.financials.runway,
          askAmount: analysis.enhanced.financials.askAmount,
          valuation: analysis.enhanced.financials.valuation,
          projectionsAssessment: analysis.enhanced.financials.projectionsAssessment,
          projections: analysis.enhanced.financials.projections,
          score: analysis.enhanced.financials.score,
        } : undefined,
        detailedRisks: analysis.enhanced?.risks?.map(r => ({
          category: r.category,
          severity: r.severity,
          description: r.description,
        })),
        bestPractices: analysis.bestPractices?.map(bp => ({
        ...
        evaluations: analysis.evaluations?.map(e => ({
          ...
          grade: e.grade,
          summary: e.summary,
          investmentReadiness: e.investmentReadiness,
          strengths: e.strengths,
          weaknesses: e.weaknesses,
          keyRecommendations: e.keyRecommendations,
        ...
        deckQuality: analysis.enhanced?.deckQuality ? {
          overallScore: analysis.enhanced.deckQuality.overallScore,
          visualDesign: analysis.enhanced.deckQuality.visualDesign,
          narrative: analysis.enhanced.deckQuality.narrative,
          dataPresentation: analysis.enhanced.deckQuality.dataPresentation,
